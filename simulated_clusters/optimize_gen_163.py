...
mean_PMRA = -282.54978587251173     # Mean PMRA and PMDEC obtained with 2D KDE approximation
mean_PMDEC = -312.9734569135252
...
# by considering that the cluster center distance is within 
# 30% to 60% of the kinematic distance estimate.
center_dist_limits_max = [0.3*kinematic_dist, 0.6*kinematic_dist]
