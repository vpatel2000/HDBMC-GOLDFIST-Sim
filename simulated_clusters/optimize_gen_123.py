...
mean_PMRA = -119.316105900249       # Mean PMRA and PMDEC obtained with 2D KDE approximation
mean_PMDEC = -319.683549211413
...
# 2-sigma of the median YSO Gaia distances.
m = 2
center_dist_limits_max = [median_distance - m*avg_err, median_distance + m*avg_err]
...
lmax = np.percentile(real['final_dist_hi'],0.15)

umin = np.percentile(real['final_dist_lo'],97.5)
umax = np.percentile(real['final_dist_hi'],97.5)
